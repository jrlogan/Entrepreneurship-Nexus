...
const accounts = [
  ...
  {
    label: 'eso_admin_sbdc',
    email: 'eso.admin@sbdc.org',
    first_name: 'SBDC',
    last_name: 'Admin',
    system_role: 'eso_admin',
  ...
  {
    label: 'entrepreneur_jane',
    email: 'jane.smith@progressable.io',
    first_name: 'Jane',
    last_name: 'Smith',
    system_role: 'entrepreneur',
    organization_id: 'org_progressable',
    ecosystem_id: 'eco_new_haven',
  },
  {
    label: 'entrepreneur_marco',
    email: 'marco@alvarezlabs.com',
    first_name: 'Marco',
    last_name: 'Alvarez',
    system_role: 'entrepreneur',
    organization_id: '',
