            ...
            <div className="space-y-4">
                ...
                <div>
                    <div className="flex items-center justify-between mb-1">
                        ...
                        {(viewer.role === 'platform_admin' || viewer.role === 'ecosystem_manager') && org.url && (
                            <button
                                type="button"
                                onClick={async () => {
                                ...
                                className="text-xs px-2.5 py-1 rounded border border-indigo-200 text-indigo-700 hover:bg-indigo-50 disabled:opacity-40 flex items-center gap-1"
                            >
                    ...
                    {org.description_auto_generated && (
                        <p className="mt-1 text-xs text-indigo-500">AI-generated — editing this will mark it as manually maintained.</p>
                    )}
