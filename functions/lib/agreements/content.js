...
exports.PRIVACY_POLICY_CONTENT = {
...
exports.FEDERATION_COMPACT_CONTENT = {
...
exports.NETWORK_MEMBERSHIP_CONTENT = {
...
function getContent(type) {
    if (type === 'privacy_policy')
        return exports.PRIVACY_POLICY_CONTENT;
    if (type === 'data_usage_agreement')
...
async function computeTextHash(content) {
