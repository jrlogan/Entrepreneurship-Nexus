...
// Helpers
// ---------------------------------------------------------------------------
const post = async (path, body, bearerToken) => {
...
const createTestUser = async (email, displayName) => {
...
const seedAdminPerson = async (uid, email) => {
...
// getInviteSummary
// ---------------------------------------------------------------------------
(0, node_test_1.describe)('getInviteSummary', () => {
    (0, node_test_1.it)('returns 400 when token is missing', async () => {
        const { status, body } = await post('getInviteSummary', {});
        assert.equal(status, 400);
        assert.ok(body.error);
    });
    (0, node_test_1.it)('returns 404 for unknown token', async () => {
        const { status, body } = await post('getInviteSummary', { token: 'totally-invalid-token-xyz' });
        assert.equal(status, 404);
    });
    (0, node_test_1.it)('returns 410 with reason=expired for an expired invite', async () => {
    ...
    (0, node_test_1.it)('returns 410 with reason=already_accepted for a used invite', async () => {
    ...
    (0, node_test_1.it)('returns 410 with reason=revoked for a revoked invite', async () => {
    ...
    (0, node_test_1.it)('returns full invite summary for a valid pending invite', async () => {
...
// acceptInvite
// ---------------------------------------------------------------------------
(0, node_test_1.describe)('acceptInvite', () => {
    (0, node_test_1.it)('returns 401 when called without auth token', async () => {
        const { status } = await post('acceptInvite', { token: 'sometoken' });
        assert.equal(status, 401);
    });
    (0, node_test_1.it)('returns 400 when invite token is missing', async () => {
    ...
    (0, node_test_1.it)('returns 404 for an unknown invite token', async () => {
    ...
    (0, node_test_1.it)('returns 403 when authenticated email does not match invite email', async () => {
    ...
    (0, node_test_1.it)('returns 410 with reason=expired when accepting an expired invite', async () => {
    ...
    (0, node_test_1.it)('returns 410 with reason=already_accepted when accepting a used invite', async () => {
    ...
    (0, node_test_1.it)('accepts a valid invite, sets person role and marks invite accepted', async () => {
...
// ---------------------------------------------------------------------------
(0, node_test_1.describe)('createInvite duplicate check', () => {
    let adminToken;
    let adminUid;
    (0, node_test_1.before)(async () => {
    ...
    (0, node_test_1.it)('blocks creating a duplicate invite when an active pending one exists', async () => {
    ...
    (0, node_test_1.it)('allows re-inviting when the existing pending invite is expired', async () => {
